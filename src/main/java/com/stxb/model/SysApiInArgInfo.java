...
public class SysApiInArgInfo {
	...
	public SysApiInArgInfo(int apiId, String cloName, String pyName,
	...
	public SysApiInArgInfo(int id, int apiId, String cloName, String pyName,
			DataType type, boolean isNull, int encode, int format) {
		super();
		this.id = id;
		this.apiId = apiId;
